        ...
        <div class="content-header">
          ...
          <% LaptopBean lap = (LaptopBean)request.getAttribute("lapUpdate"); %>
            <div class="form-group row">
              <label for="lapId" class="col-sm-2 col-form-label">ID Laptop</label>
              <div class="col-sm-10">
                <input readonly type="text" class="form-control" name="lapId" id="lapId" value="<%= lap.getLapID()%>">
              </div>
            </div>
           <div class="form-group row">
              <label for="lapName" class="col-sm-2 col-form-label">Laptop's name</label>
              <div class="col-sm-10">
                <input  type="text" class="form-control" name="lapName" id="lapName" value="<%= lap.getLapName() %>">
              </div>
            </div>
             <div class="form-group row">
              ...
              <div class="col-sm-10">
				...
				<select name="companyId" class="form-control">
						...
						%> 
							<option value="<%= compList.get(i).getCompanyId()%>"<%if(lap.getCompanyId().equals(compList.get(i).getCompanyId())){%>
							selected<% 	} %>><%= compList.get(i).getCompanyName() %></option>
						<% 	} %>
                      </select>
              </div>
            </div>
              ...
              <div class="col-sm-10">
				...
				<select name="cardId" class="form-control" >
						...
						%> 
							...
							<option value="<%= cardList.get(i).getCardId()%>" <%if(lap.getCardId().equals(cardList.get(i).getCardId())){%>
							selected<% 	} %> ><%= cardList.get(i).getCardName() %></option>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-10">
                <input  type="number" class="form-control" name="amount" id="amount" value="<%=lap.getAmount() %>">
              </div>
            </div>
             <div class="form-group row">
              <label for="price" class="col-sm-2 col-form-label">Price</label>
              <div class="col-sm-10">
                <input  type="number" class="form-control" name="price" id="price" value="<%=lap.getPrice() %>">
              </div>
            </div>

            <div class="form-group row">
              <div class="col-sm-10">
                <input type="submit" class="btn btn-primary" name="btnUpdateLaptop" value="Update">
              </div>
            </div>
          </form>
        </div>
